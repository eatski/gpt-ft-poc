...
import { reportFoodByPersona } from "@/usecases/openai/reportFood";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse<FoodReport | string>) {
  if (req.method !== "POST") {
